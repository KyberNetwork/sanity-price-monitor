...
from pricemonitor.volatility.trades_from_collector_archive import TradesFromCollectorArchive, TradesDownloader
...
async def main(loop):
    ...
    for coin in COINS:
        ...
        for exchange in EXCHANGES:
            average_volatility = get_average_of_hourly_volatility(trades_per_coin[coin], exchange_filter=exchange)
